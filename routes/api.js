...
router.get('/logs', (req, res) => {
  ...
  conn.on('ready', () => {
    ...
    const command = `docker logs -f --tail 100 --timestamps ${selectedHost.container}`;
  ...
  conn.connect({
    ...
    privateKey: require('fs').readFileSync(process.env.SSH_KEY_PATH || 'E:/Workspace/boanhealth.ai/_doc/vultr_key/id_ed25519')
  });
});
